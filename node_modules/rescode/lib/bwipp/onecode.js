...
BWIPJS.bwipp["onecode"]=function() {
	...
	function $f8(){
		...
		if (t===undefined) throw new Error("dict: spacecnt: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		this.ptr-=3;
		this.stk[this.ptr++]="spacecnt"; //ident
		var t=this.dstk.get("spacecnt");
		if (t===undefined) throw new Error("dict: spacecnt: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
	...
	function $f9(){
		...
		if (t===undefined) throw new Error("dict: txtdict: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t===undefined) throw new Error("dict: i: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f10(){
		...
		if (t===undefined) throw new Error("dict: base: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f20(){
		...
		if (t===undefined) throw new Error("dict: a: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		var t=this.dstk.get("offset");
		if (t===undefined) throw new Error("dict: offset: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=2;
		if (typeof(this.stk[this.ptr-1])=="number") {
	...
	function $f21(){
		...
		this.stk[this.ptr++]="offset"; //ident
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]<this.stk[this.ptr-1]; this.ptr--;
	...
	function $f32(){
		...
		if (t===undefined) throw new Error("dict: bintmp: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f33(){
		...
		if (t===undefined) throw new Error("dict: bytes: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t===undefined) throw new Error("dict: i: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f34(){
		this.stk[this.ptr++]="fcs"; //ident
		var t=this.dstk.get("fcs");
		if (t===undefined) throw new Error("dict: fcs: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=1;
	...
	function $f36(){
		...
		if (t===undefined) throw new Error("dict: dat: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1])=="boolean")
			this.stk[this.ptr-2]=!this.stk[this.ptr-2]&&this.stk[this.ptr-1] || this.stk[this.ptr-2]&&!this.stk[this.ptr-1];
		else this.stk[this.ptr-2]=this.stk[this.ptr-2]^this.stk[this.ptr-1];
	...
	function $f46(){
		...
		if (t===undefined) throw new Error("dict: tab513: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].get(this.stk[this.ptr-1]);
	...
	function $f47(){
		...
		if (t===undefined) throw new Error("dict: tab213: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
	...
	function $f48(){
		...
		if (t===undefined) throw new Error("dict: chars: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t===undefined) throw new Error("dict: i: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f55(){
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="dec"; //ident
		var t=this.dstk.get("chars");
		if (t===undefined) throw new Error("dict: chars: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("barmap");
		if (t===undefined) throw new Error("dict: barmap: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t===undefined) throw new Error("dict: i: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		if (t===undefined) throw new Error("dict: dec: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1])=="boolean") this.stk[this.ptr-1]=!this.stk[this.ptr-1];
		else this.stk[this.ptr-1]=~this.stk[this.ptr-1];
		var t=this.dstk.get("asc");
		if (t===undefined) throw new Error("dict: asc: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		if (typeof(this.stk[this.ptr-1])=="boolean") this.stk[this.ptr-1]=!this.stk[this.ptr-1];
		else this.stk[this.ptr-1]=~this.stk[this.ptr-1];
		if (typeof(this.stk[this.ptr-1])=="boolean") this.stk[this.ptr-2]=this.stk[this.ptr-2]&&this.stk[this.ptr-1];
	...
	this.stk[this.ptr-1]=this.stk[this.ptr-1].length;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="txtdict"; //ident
	this.stk[this.ptr++]=Infinity;
	this.stk[this.ptr++]=2;
	this.stk[this.ptr]=this.stk[this.ptr-1]; this.ptr++;
	this.stk[this.ptr++]=5;
	...
	this.stk[this.ptr-3]=this.stk[this.ptr-3].subset(this.stk[this.ptr-2],this.stk[this.ptr-1]); this.ptr-=2;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="normalize"; //ident
	this.stk[this.ptr++]=$f18;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="bigadd"; //ident
	...
	if (t===undefined) throw new Error("dict: bigadd: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="binval"; //ident
	this.stk[this.ptr++]=Infinity;
	...
	for (t48 in t49) {
		if (t49 instanceof BWIPJS.psstring || t49 instanceof BWIPJS.psarray) {
			...
			this.stk[this.ptr++]=t49.get(t48);
		} else {
			this.stk[this.ptr++]=t48;
			this.stk[this.ptr++]=t49[t48];
		}
	...
	if (t===undefined) throw new Error("dict: normalize: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="binval"; //ident
	this.stk[this.ptr++]=Infinity;
	...
	for (t51 in t52) {
		if (t52 instanceof BWIPJS.psstring || t52 instanceof BWIPJS.psarray) {
			...
			this.stk[this.ptr++]=t52.get(t51);
		} else {
			this.stk[this.ptr++]=t51;
			this.stk[this.ptr++]=t52[t51];
		}
	...
	for (t54 in t55) {
		if (t55 instanceof BWIPJS.psstring || t55 instanceof BWIPJS.psarray) {
			...
			this.stk[this.ptr++]=t55.get(t54);
		} else {
			this.stk[this.ptr++]=t54;
			this.stk[this.ptr++]=t55[t54];
		}
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="bytes"; //ident
	this.stk[this.ptr++]=13;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="bintmp"; //ident
	this.stk[this.ptr++]=Infinity;
	var t=this.dstk.get("binval");
	if (t===undefined) throw new Error("dict: binval: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr++]="tab513"; //ident
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="tab213"; //ident
	...
	this.stk[this.ptr++]="barmap"; //ident
