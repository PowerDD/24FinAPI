...
BWIPJS.bwipp["auspost"]=function() {
	...
	function $f13(){
		...
		this.stk[this.ptr++]="ciflen"; //ident
		var t=this.dstk.get("barlen");
		if (t===undefined) throw new Error("dict: barlen: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=10;
	...
	function $f19(){
		this.stk[this.ptr++]="next"; //ident
		var t=this.dstk.get("next");
		if (t===undefined) throw new Error("dict: next: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=67;
	...
	function $f20(){
		var t=this.dstk.get("rstable");
		if (t===undefined) throw new Error("dict: rstable: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=64;
		var t=this.dstk.get("next");
		if (t===undefined) throw new Error("dict: next: undefined");
	...
	function $f21(){
		var t=this.dstk.get("nextcell");
		if (t===undefined) throw new Error("dict: nextcell: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("nextcell");
		if (t===undefined) throw new Error("dict: nextcell: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	function $f22(){
		...
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		this.stk[this.ptr++]="nextcell"; //ident
		...
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr++]=64;
		var t=this.dstk.get("prev");
		if (t===undefined) throw new Error("dict: prev: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
		var t=this.dstk.get("j");
		if (t===undefined) throw new Error("dict: j: undefined");
	...
	function $f28(){
		...
		this.ptr-=2;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
		var t=this.dstk.get("checkcode");
		if (t===undefined) throw new Error("dict: checkcode: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.dstk.get("i");
		if (t===undefined) throw new Error("dict: i: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="custinfoenc"; //ident
	...
	var t=this.dstk.get("custinfoenc");
	if (t===undefined) throw new Error("dict: custinfoenc: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	...
	this.stk[this.ptr++]=22;
	var t=this.dstk.get("ciflen");
	if (t===undefined) throw new Error("dict: ciflen: undefined");
	if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
	this.stk[this.ptr++]=1;
	var t=this.dstk.get("encstr");
	...
	this.stk[this.ptr++]="rstable"; //ident
	this.stk[this.ptr++]=64;
	this.stk[this.ptr++]=64;
	this.stk[this.ptr-2]=this.stk[this.ptr-2]*this.stk[this.ptr-1]; this.ptr--;
	this.stk[this.ptr-1]=BWIPJS.psarray(this.stk[this.ptr-1]);
	...
	this.stk[this.ptr++]="checkcode"; //ident
