...
BWIPJS.bwipp["micropdf417"]=function() {
	...
	function $f22(){
		...
		for (t34 in t35) {
			if (t35 instanceof BWIPJS.psstring || t35 instanceof BWIPJS.psarray) {
				if (t34.charCodeAt(0) > 57) continue;
				this.stk[this.ptr++]=t35.get(t34);
			} else {
				this.stk[this.ptr++]=t34;
				this.stk[this.ptr++]=t35[t34];
			}
	...
	function $f25(){
		...
		if (t===undefined) throw new Error("dict: ccametrics: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	}
	function $f26(){
	...
	function $f47(){
		...
		for (t99 in t100) {
			if (t100 instanceof BWIPJS.psstring || t100 instanceof BWIPJS.psarray) {
				if (t99.charCodeAt(0) > 57) continue;
				this.stk[this.ptr++]=t100.get(t99);
			} else {
				this.stk[this.ptr++]=t99;
				this.stk[this.ptr++]=t100[t99];
			}
	...
	function $f50(){
		...
		if (t===undefined) throw new Error("dict: raps: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-2]; this.stk[this.ptr-2]=this.stk[this.ptr-1]; this.stk[this.ptr-1]=t;
		if (this.stk[this.ptr-2] instanceof BWIPJS.psstring || this.stk[this.ptr-2] instanceof BWIPJS.psarray)
			this.stk[this.ptr-2]=this.stk[this.ptr-2].get(this.stk[this.ptr-1]);
	...
	function $f52(){
		...
		if (t===undefined) throw new Error("dict: rapl: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
		...
		if (t===undefined) throw new Error("dict: raptobits: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		var t=this.stk[this.ptr-1];
		for (var i = 0; i < t.length; i++) this.stk[this.ptr-1+i]=t.get(i);
		this.ptr += t.length;
		...
		if (t===undefined) throw new Error("dict: clst: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		if (t===undefined) throw new Error("dict: rapr: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	...
	function $f55(){
		...
		if (t===undefined) throw new Error("dict: cca: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		...
		if (t===undefined) throw new Error("dict: rapc: undefined");
		if (t instanceof Function) t.call(this); else this.stk[this.ptr++]=t;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]+this.stk[this.ptr-1]; this.ptr--;
		this.stk[this.ptr++]=1;
		this.stk[this.ptr-2]=this.stk[this.ptr-2]-this.stk[this.ptr-1]; this.ptr--;
	...
	this.stk[this.ptr++]=BWIPJS.psarray(t);
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="ccametrics"; //ident
	this.stk[this.ptr++]=Infinity;
	...
	this.dict[this.stk[this.ptr-2]]=this.stk[this.ptr-1]; this.ptr-=2;
	this.stk[this.ptr++]="raptobits"; //ident
